...
def apply_logreg_mapping(df_probs, logreg_models_path):
    ...
    try:
        ...
        print("Error loading path to logistic regression models. Please ensure that the pickle file is in the bert_checkpoint folder.")
        print(f"Exception: {e}")
...
def label_and_save_preds(checkpoint_folder, csv_path, out_path):
    ...
    @param checkpoint_path (string): location of saved model bert_checkpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--checkpoint_folder', type=str, nargs='?', required=False, default="bert_checkpoint",
