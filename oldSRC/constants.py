CHECKPOINT_FOLDER = 'bert_checkpoint'
REPORTS_FOLDER = 'sample_reports'
...
#List of conditions to evaluate model's performance during validation
EVAL_CONDITIONS = set(CONDITIONS)
